...
open class MotionAnimator: NSObject {
  ...
  func start() {
    ...
    displayLink.add(to: RunLoop.main, forMode: RunLoop.Mode(rawValue: RunLoop.Mode.RunLoop.Mode.common.rawValue))
  ...
  func stop() {
    ...
    displayLink.remove(from: RunLoop.main, forMode: RunLoop.Mode(rawValue: RunLoop.Mode.RunLoop.Mode.common.rawValue))
    displayLink = nil
